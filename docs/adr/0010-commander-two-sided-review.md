...
- Wide rows truncate on narrow terminals; column-priority and reflow behavior is left to the keyboard-and-terminal decision on wayfinder map [#37](https://github.com/phassle/VibeFileSync/issues/37).
